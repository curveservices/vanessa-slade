...
const ElevenPlus = () => {
    return ( 
        <SingleSubject
            ...
            thirdRightP="Verbal Reasoning is skills rather than knowledge based. The GL Verbal Reasoning exam will test your child’s ability to process verbal information, recognise similarities and differences between words, apply logical thinking and problem-solving skills, identify patterns, and demonstrate an understanding of the rules and meaning of language."
            thirdRightP2="For example, they may be asked to crack codes through words and numbers, as well as finding words within words or completing a sequence of words. I will help your child to extend their vocabulary and substitute a wide range of words with synonyms and antonyms."
